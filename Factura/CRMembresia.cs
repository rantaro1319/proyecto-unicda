...
namespace Factura {
    ...
    public class CRMembresia : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Factura.CRMembresia.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCRMembresia : Component, ICachedReport {
        
        public CachedCRMembresia() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CRMembresia rpt = new CRMembresia();
            rpt.Site = this.Site;
            return rpt;
        }
